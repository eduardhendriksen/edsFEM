...
from edsFEM.renderutils.profiles import I_Profile_Renderer
import numpy as np
...
class Renderer(ShowBase):
    ...
    def render_beam_profile(self, beam, scale='mm'):
        ...
        It is currently only possible to render I Beam profiles.
        """
        s = self.scale_check(scale)
    ...
    def make_lighting(self):
        """
        Creates point lights on the top four corners of the render
        """
        if self.render_extents is not None:
